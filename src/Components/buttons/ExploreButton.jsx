...
const ExploreButton = ({ children, className, ...rest }) => {
  return (
    <button
      className={cn(
        "py-2 w-fit rounded px-6 mb-4 mt-6 bg-sky-700 hover:bg-sky-600 duration-300 text-white flex items-center justify-center overflow-hidden hover:overflow-visible relative group",
        className
      )}
      {...rest}
    >
